...
namespace UHFPS.Runtime
{
    ...
    public class FuseboxPuzzle : PuzzleBaseSimple, IInventorySelector, ISaveable
    {
        ...
        public string EmissionColorName = "_EmissiveColor";
        ...
        private void InsertFuse(FuseElement fuse, bool connected)
        {
            ...
            if(UseEmission) fuse.LightRenderer.material.SetEmission(connected, fuseColor, EmissionIntensity, EmissionColorName);
