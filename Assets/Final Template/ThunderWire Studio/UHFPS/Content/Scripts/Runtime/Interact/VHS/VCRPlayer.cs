...
namespace UHFPS.Runtime
{
    public class VCRPlayer : MonoBehaviour, IInventorySelector, ISaveable
    {
        ...
        public float emissionIntensity = 50f;
        ...
        public void SetPower(bool power)
        {
            ...
            if (isPoweredOn = power)
            {
                ...
                if(emissionMaterial.IsAssigned)
                    emissionMaterial.ClonedMaterial.SetEmission(true, emissionIntensity, emissionKeyword);
            }
            else
            {
                ...
                if (emissionMaterial.IsAssigned)
                    emissionMaterial.ClonedMaterial.SetEmission(false, emissionIntensity, emissionKeyword);
            }
