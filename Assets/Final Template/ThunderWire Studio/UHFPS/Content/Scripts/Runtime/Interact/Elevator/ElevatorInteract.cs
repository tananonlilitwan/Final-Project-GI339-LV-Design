...
namespace UHFPS.Runtime
{
    ...
    public class ElevatorInteract : MonoBehaviour, IInteractStart
    {
        ...
        public void InteractStart()
        {
            ...
            if (interact)
            {
                if (IndicatorMaterial.IsAssigned)
                    IndicatorMaterial.ClonedMaterial.SetEmission(true, EmissionIntensity, EmissionKeyword);
        ...
        public void SetEmission(bool state)
        {
            ...
            IndicatorMaterial.ClonedMaterial.SetEmission(state, EmissionIntensity, EmissionKeyword);
        }
