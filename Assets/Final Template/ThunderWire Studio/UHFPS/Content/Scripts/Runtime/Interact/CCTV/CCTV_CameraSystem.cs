    ...
    public class CCTV_CameraSystem : MonoBehaviour
    {
        ...
        private void OnBackgroundFade()
        {
            ...
            else
            {
                ...
                // prevent cameras from staying enabled
                foreach (var camera in Cameras)
                {
                    camera.LiveCamera.targetTexture = null;
                    camera.LiveCamera.gameObject.SetActive(false);
        ...
        private Texture2D CaptureCameraView()
        {
            ...
            RenderTexture renderTexture = new(OutputTextureSize.x, OutputTextureSize.y, 24, RenderTextureFormat.ARGB32);
            camera.targetTexture = renderTexture;
            camera.Render();

            Texture2D texture = new(OutputTextureSize.x, OutputTextureSize.y, TextureFormat.ARGB32, false);
