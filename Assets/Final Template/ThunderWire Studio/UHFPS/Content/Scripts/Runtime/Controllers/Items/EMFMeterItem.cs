...
namespace UHFPS.Runtime
{
    public class EMFMeterItem : PlayerItemBehaviour
    {
        ...
        public float DisplayIntensity = 2f;
        ...
        private void SetIndicators(float milligauss)
        {
            ...
            for (int i = 0; i < Indicators.Count; i++)
            {
                ...
                {
                    indicator.SetEmission(true, EmissionIntensity, EmissionKeyword);
                ...
                {
                    indicator.SetEmission(false, EmissionIntensity, EmissionKeyword);
                }
            }
        ...
        {
            Display.ClonedMaterial.SetEmission(state, DisplayIntensity, EmissionKeyword);
            DisplayCanvas.SetActive(state);
        }
