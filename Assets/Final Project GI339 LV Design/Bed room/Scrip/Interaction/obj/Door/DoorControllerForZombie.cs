...
public class DoorControllerForZombie : MonoBehaviour, IDropHandler
{
    ...
    [SerializeField] private GameObject zombieObjectToActivate; // Zombie หรือ Spawner ที่จะเปิดใช้งาน
    ...
    private void OpenDoor()
    {
        ...
        if (zombieObjectToActivate != null)
        {
            zombieObjectToActivate.SetActive(true); // เปิด Zombie หรือ Spawner
        }
