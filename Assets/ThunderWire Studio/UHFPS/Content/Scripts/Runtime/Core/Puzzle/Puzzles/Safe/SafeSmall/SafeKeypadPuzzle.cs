    ...
    public class SafeKeypadPuzzle : PuzzleBase, ISaveable
    {
        ...
        public override void OnBackgroundFade()
        {
            ...
            else if (!isUnlocked)
            {
                ...
                {
                    Indicators[i].material.SetEmission(true, DefaultLightColor, EmissionIntensity, EmissionColor);
                }
            }
            else if(isUnlocked)
            {
        ...
        private void SetIndicator()
        {
            ...
            for (int i = 0; i < MAX_INDICATORS; i++)
            {
                ...
                Indicators[i].material.SetEmission(true, color, EmissionIntensity, EmissionColor);
            }
        }
        ...
        IEnumerator OnAccessUpdated(bool granted)
        {
            ...
            for (int i = 0; i < MAX_INDICATORS; i++)
            {
                Indicators[i].material.SetEmission(false, color, EmissionIntensity, EmissionColor);
            }
